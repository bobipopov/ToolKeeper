-- Allow admins to create both user and admin accounts
...
BEGIN
  ...
  -- Set email as confirmed. Do not update confirmed_at directly because
  -- in some GoTrue versions this column is generated/protected.
  UPDATE auth.users
